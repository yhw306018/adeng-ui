<template>
  <div>
    ...
    <br />
    <br />
    <Button type="success" icon="discount">图标按钮</Button>
    <Button type="primary" icon="discount" icon-position="right">图标按钮</Button>
    <Button type="primary" icon="discount"></Button>

    <br />
    <br />
    <Icon name="arrow-double-left" color="red" />
    <Icon name="arrow-double-left" color="green" />
    <Icon name="arrow-double-left" color="blue" />
    <Icon name="arrow-double-left" color="yellow" />
  </div>
</template>
<script lang="ts" setup>
import { Button, Icon } from 'adeng-ui';
</script>
<style lang="less">
.xd-button {
  margin-right: 10px;
